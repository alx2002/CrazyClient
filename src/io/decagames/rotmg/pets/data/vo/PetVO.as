...
package io.decagames.rotmg.pets.data.vo
{
	...
	public class PetVO extends PetSkinRenderer implements IPetVO
	{
		...
		public function totalAbilitiesLevel():int
		{
			...
			for each (_local_1 in this._abilityList)
			{
				if (((_local_1.getUnlocked()) && (_local_1.level)))
				{
					_local_2 = (_local_2 + _local_1.level);
				}
				;
			}
			;
		...
		public function get totalMaxAbilitiesLevel():int
		{
			...
			for each (_local_1 in this._abilityList)
			{
				...
				{
					_local_2 = (_local_2 + this._maxAbilityPower);
				}
				;
			}
			;
		...
		public function maxedAllAbilities():Boolean
		{
			...
			;
			return (_local_2 == this._abilityList.length);
		}
		...
		{
			((Boolean(_arg_1.@instanceId)) && (this.setID(_arg_1.@instanceId)));
			((Boolean(_arg_1.@type)) && (this.setType(_arg_1.@type)));
			((Boolean(_arg_1.@skin)) && (this.setSkin(_arg_1.@skin)));
			((Boolean(_arg_1.@name)) && (this.setName(_arg_1.@name)));
			((Boolean(_arg_1.@rarity)) && (this.setRarity(_arg_1.@rarity)));
			((Boolean(_arg_1.@maxAbilityPower)) && (this.setMaxAbilityPower(_arg_1.@maxAbilityPower)));
		}
		...
		public function extractAbilityData(_arg_1:XML):void
		{
			...
			var _local_4:int;
			var _local_5:uint = this._abilityList.length;
			_local_2 = 0;
			while (_local_2 < _local_5)
			{
				_local_3 = this._abilityList[_local_2];
