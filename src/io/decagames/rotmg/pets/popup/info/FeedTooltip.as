...
package io.decagames.rotmg.pets.popup.info
{
    ...
    public class FeedTooltip extends ToolTip 
    {
        ...
        private function createProgressIcon():void
        {
            ...
            _local_2.graphics.beginFill(6341728, 1);
            _local_2.graphics.drawRect(0, 0, 160, 4);
            _local_2.graphics.endFill();
            this.progressIconContainer.addChild(_local_2);
            var _local_3:Sprite = new Sprite();
            _local_3.graphics.beginFill(15305801, 1);
            _local_3.graphics.drawRect(0, 0, 120, 4);
            _local_3.graphics.endFill();
            this.progressIconContainer.addChild(_local_3);
            _local_1 = new UILabel();
            DefaultLabelFormat.petStatLabelLeft(_local_1, 6341728);
            _local_1.text = "MAX";
            _local_1.x = 165;
            _local_1.y = -5;
