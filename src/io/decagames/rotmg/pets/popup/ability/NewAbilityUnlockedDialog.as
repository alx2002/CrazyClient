...
package io.decagames.rotmg.pets.popup.ability
{
    ...
    public class NewAbilityUnlockedDialog extends ModalPopup 
    {
        ...
        public function NewAbilityUnlockedDialog(_arg_1:String)
        {
            ...
            addChild(_local_2);
            _local_5 = TextureParser.instance.getSliceScalingBitmap("UI", "popup_content_inset", 229);
            addChild(_local_5);
            _local_5.height = 35;
            _local_5.y = ((_local_2.y + _local_2.textHeight) + 10);
            _local_5.x = Math.round(((_contentWidth - _local_5.width) / 2));
            _local_3 = new UILabel();
            DefaultLabelFormat.newAbilityName(_local_3);
            _local_3.y = (_local_5.y + 8);
            _local_3.width = _contentWidth;
            _local_3.wordWrap = true;
            _local_3.text = _arg_1;
            addChild(_local_3);
            _local_4 = new TextureParser().getSliceScalingBitmap("UI", "main_button_decoration", 194);
            addChild(_local_4);
            _local_4.y = ((_local_5.y + _local_5.height) + 10);
