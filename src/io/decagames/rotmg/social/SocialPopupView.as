...
package io.decagames.rotmg.social
{
    ...
    public class SocialPopupView extends ModalPopup 
    {
        ...
        public function addFriendCategory(_arg_1:String):void
        {
            ...
            this.friendsGrid.addGridElement(_local_3);
        }
        ...
        {
            var _local_5:Sprite;
            var _local_6:UITab = new UITab(_arg_1, true);
            ...
            var _local_7:int = ((_arg_4) ? 410 : 375);
            var _local_8:UIScrollbar = new UIScrollbar(_local_7);
            _local_8.mouseRollSpeedFactor = 1;
            _local_8.scrollObject = _local_6;
            _local_8.content = _arg_2;
            _local_8.x = ((this.contentInset.x + this.contentInset.width) - 25);
            _local_8.y = _arg_2.y;
            this._tabContent.addChild(_local_8);
            _local_5 = new Sprite();
            _local_5.graphics.beginFill(0);
            _local_5.graphics.drawRect(0, 0, 350, (_local_7 - 5));
            _local_5.x = _arg_2.x;
            _local_5.y = _arg_2.y;
            _arg_2.mask = _local_5;
            this._tabContent.addChild(_local_5);
            _local_6.addContent(this._tabContent);
            return (_local_6);
        }
        ...
        private function createSearchAndAdd():void
        {
            ...
            var _local_2:SliceScalingBitmap = this.createSearchInset(296);
            _local_2.x = (this.addButton.x + this.addButton.width);
            _local_2.y = 10;
            this._tabContent.addChild(_local_2);
            _local_1 = this.createSearchIcon();
            ...
            this.search.x = ((_local_1.x + _local_1.width) - 5);
            this.search.y = (_local_2.y + 7);
