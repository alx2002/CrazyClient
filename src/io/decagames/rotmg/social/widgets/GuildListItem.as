...
package io.decagames.rotmg.social.widgets
{
    ...
    public class GuildListItem extends BaseListItem 
    {
        ...
        private function createButtons():void
        {
            ...
            var _local_2:String;
            var _local_3:String;
            var _local_4:int = ((this._isMe) ? 0xFF : 205);
            this.guildRank = addButton("lofiInterfaceBig", GuildUtil.getRankIconIdByRank(this._guildMemberRank), _local_4, 12, GuildUtil.rankToString(this._guildMemberRank));
            if ((!(this._isMe)))
            {
                ...
                _local_1 = this._guildMemberVO.serverName;
                ...
                this.teleportButton.enabled = ((this._isOnline) && (!(_local_2 == _local_1)));
                this.messageButton = addButton("lofiInterfaceBig", 21, 0xFF, 12, TextKey.PLAYERMENU_PM);
                this.messageButton.enabled = this._isOnline;
            };
            var _local_5:String = ((this._isMe) ? "Leave Guild" : "Remove member");
            this.removeButton = addButton("lofiInterfaceBig", 12, 280, 12, _local_5);
            if ((!(this._isMe)))
            {
