...
package io.decagames.rotmg.social.model
{
    ...
    public class SocialModel 
    {
        ...
        public function getFilterFriends(_arg_1:String):Vector.<FriendVO>
        {
            ...
            {
                _local_2 = this._onlineFriends[_local_4];
                if (_local_2.getName().search(_local_3) >= 0)
                {
                    this._onlineFilteredFriends.push(_local_2);
                };
                _local_4++;
            };
            _local_4 = 0;
            ...
            {
                _local_2 = this._offlineFriends[_local_4];
                if (_local_2.getName().search(_local_3) >= 0)
                {
                    this._offlineFilteredFriends.push(_local_2);
                };
                _local_4++;
            };
        ...
        public function getAllInvitations():Vector.<FriendVO>
        {
            ...
            var _local_2:Vector.<FriendVO> = new Vector.<FriendVO>();
        ...
        private function seedGuild(_arg_1:XML):void
        {
            ...
            var _local_6:XMLList = _arg_1.child("Member");
            if (_local_6.length() > 0)
            {
                for each (_local_2 in _local_6)
                {
                    _local_3 = new GuildMemberVO();
                    _local_4 = _local_2.Name;
                    if (_local_4 == this.hudModel.getPlayerName())
                    {
                        _local_3.isMe = true;
                        this._guildVO.myRank = _local_2.Rank;
                    };
                    _local_3.name = _local_4;
                    _local_3.rank = _local_2.Rank;
                    _local_3.fame = _local_2.Fame;
                    _local_3.player = this.getPlayerObject(_local_4, _local_2);
                    if (_local_2.hasOwnProperty("Online"))
                    {
                        _local_3.isOnline = true;
                        _local_5 = String(_local_2.Online);
                        _local_3.serverAddress = _local_5;
                        _local_3.serverName = this.serverNameDictionary()[_local_5];
                        this._onlineGuildMembers.push(_local_3);
                    }
                    else
                    {
                        _local_3.lastLogin = this.getLastLoginInSeconds(_local_2.LastLogin);
                        this._offlineGuildMembers.push(_local_3);
                    };
                };
            };
            this.updateGuildData();
