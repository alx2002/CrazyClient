...
package io.decagames.rotmg.fame
{
	...
	public class FameContentPopup extends ModalPopup
	{
		...
		private function createStatsTab():UITab
		{
			...
			_local_3.addChild(this.statsContainer);
			var _local_4:UIScrollbar = new UIScrollbar(338);
			_local_4.mouseRollSpeedFactor = 1;
			_local_4.scrollObject = _local_1;
			_local_4.content = this.statsContainer;
			_local_3.addChild(_local_4);
			_local_4.x = ((this.contentInset.x + this.contentInset.width) - 25);
			_local_4.y = 7;
			_local_2 = new Sprite();
			_local_2.graphics.beginFill(0);
			_local_2.graphics.drawRect(0, 0, 340, 342);
			_local_2.x = this.statsContainer.x;
			_local_2.y = this.statsContainer.y;
			this.statsContainer.mask = _local_2;
