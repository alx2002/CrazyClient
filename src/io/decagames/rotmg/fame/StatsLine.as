...
package io.decagames.rotmg.fame
{
	...
	public class StatsLine extends Sprite
	{
		...
		public function StatsLine(_arg_1:String, _arg_2:String, _arg_3:String, _arg_4:int, _arg_5:Boolean = false)
		{
			...
			{
				_local_8.color = 0xFFC800;
			}
			else
			{
				_local_8.color = 5544494;
			}
			;
			_local_8.font = FontModel.DEFAULT_FONT_NAME;
			_local_8.size = 13;
			_local_8.bold = true;
			_local_8.align = TextFormatAlign.LEFT;
			...
			if ((!(_arg_5)))
			{
				...
				this.fameValue.defaultTextFormat = _local_8;
			...
			{
				_local_6 = 36;
				this.lock = new Bitmap(TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiInterface2", 5), null, _local_6, true, 0, 0));
				Tint.add(this.lock, 9971490, 1);
				addChild(this.lock);
				this.lock.x = ((this.lineWidth - _local_6) + 5);
				this.lock.y = -8;
			}
			;
