...
package io.decagames.rotmg.dailyQuests.view.list
{
    ...
    public class DailyQuestsList extends Sprite 
    {
        ...
        private function createEventsTab():UITab
        {
            ...
            _local_3.addChild(this.eventsContainer);
            var _local_4:UIScrollbar = new UIScrollbar(365);
            _local_4.mouseRollSpeedFactor = 1;
            _local_4.scrollObject = _local_1;
            _local_4.content = this.eventsContainer;
            _local_3.addChild(_local_4);
            _local_4.x = ((this.contentInset.x + this.contentInset.width) - 25);
            _local_4.y = 7;
            _local_2 = new Sprite();
            _local_2.graphics.beginFill(0);
            _local_2.graphics.drawRect(0, 0, 230, 365);
            _local_2.x = this.eventsContainer.x;
            _local_2.y = this.eventsContainer.y;
            this.eventsContainer.mask = _local_2;
            _local_3.addChild(_local_2);
            _local_1.addContent(_local_3);
            return (_local_1);
        }
