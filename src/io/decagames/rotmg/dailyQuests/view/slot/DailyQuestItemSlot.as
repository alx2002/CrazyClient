...
package io.decagames.rotmg.dailyQuests.view.slot
{
	...
	public class DailyQuestItemSlot extends Sprite
	{
		...
		private function renderItem():void
		{
			...
			;
			var _local_3:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this._itemID, (SLOT_SIZE * 2), true);
			_local_3 = _local_3.clone();
			var _local_4:XML = ObjectLibrary.xmlLibrary_[this._itemID];
			...
			{
				_local_1 = this.bitmapFactory.make(new StaticStringBuilder(String(_local_4.Quantity)), 12, 0xFFFFFF, false, new Matrix(), true);
				_local_2 = new Matrix();
			...
			{
				GreyScale.setGreyScale(_local_3);
			}
			;
