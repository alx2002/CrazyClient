...
package io.decagames.rotmg.ui.sliceScaling
{
    ...
    public class SliceScalingBitmap extends Bitmap 
    {
        ...
        private function prepare9grid():void
        {
            ...
            var _local_5:BitmapData = new BitmapData((this.currentWidth + this.margin.x), (this.currentHeight + this.margin.y), true, 0);
            var _local_6:Array = [0, this.scaleGrid.top, this.scaleGrid.bottom, this.bitmapDataToSlice.height];
            var _local_7:Array = [0, this.scaleGrid.left, this.scaleGrid.right, this.bitmapDataToSlice.width];
            var _local_8:Array = [0, this.scaleGrid.top, (this.currentHeight - (this.bitmapDataToSlice.height - this.scaleGrid.bottom)), this.currentHeight];
            var _local_9:Array = [0, this.scaleGrid.left, (this.currentWidth - (this.bitmapDataToSlice.width - this.scaleGrid.right)), this.currentWidth];
            while (_local_10 < 3)
            {
                _local_1 = 0;
                while (_local_1 < 3)
                {
                    _local_2.setTo(_local_7[_local_10], _local_6[_local_1], (_local_7[(_local_10 + 1)] - _local_7[_local_10]), (_local_6[(_local_1 + 1)] - _local_6[_local_1]));
                    _local_3.setTo(_local_9[_local_10], _local_8[_local_1], (_local_9[(_local_10 + 1)] - _local_9[_local_10]), (_local_8[(_local_1 + 1)] - _local_8[_local_1]));
                    _local_4.identity();
                    _local_4.a = (_local_3.width / _local_2.width);
                    _local_4.d = (_local_3.height / _local_2.height);
                    _local_4.tx = (_local_3.x - (_local_2.x * _local_4.a));
                    _local_4.ty = (_local_3.y - (_local_2.y * _local_4.d));
                    _local_5.draw(this.bitmapDataToSlice, _local_4, null, null, _local_3);
                    _local_1++;
                };
                _local_10++;
            };
            this.bitmapData = _local_5;
        }
