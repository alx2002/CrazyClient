...
package io.decagames.rotmg.shop.packages.contentPopup
{
    ...
    public class PackageBoxContentPopupMediator extends Mediator 
    {
        ...
        private function addContentList(_arg_1:String, _arg_2:int, _arg_3:int, _arg_4:int):void
        {
            ...
            var _local_7:String;
            var _local_8:String;
            var _local_9:ItemBox;
            var _local_10:SlotBox;
            var _local_11:SlotBox;
            var _local_12:SlotBox;
            var _local_13:int = 5;
            var _local_14:Number = (260 - _local_13);
            this.contentGrids = new UIGrid(_local_14, 1, 2);
            if (_arg_1 != "")
            {
                ...
                {
                    _local_9 = new ItemBox(_local_8, _local_6[_local_8], true, "", false);
                    this.contentGrids.addGridElement(_local_9);
                };
            };
            if (_arg_2 > 0)
            {
                _local_10 = new SlotBox(SlotBox.CHAR_SLOT, _arg_2, true, "", false);
                this.contentGrids.addGridElement(_local_10);
            };
            if (_arg_3 > 0)
            {
                _local_11 = new SlotBox(SlotBox.VAULT_SLOT, _arg_3, true, "", false);
                this.contentGrids.addGridElement(_local_11);
            };
            if (_arg_4 > 0)
            {
                _local_12 = new SlotBox(SlotBox.GOLD_SLOT, _arg_4, true, "", false);
