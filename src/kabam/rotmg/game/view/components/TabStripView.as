...
package kabam.rotmg.game.view.components
{
    ...
    public class TabStripView extends Sprite 
    {
        ...
        {
            var _local_1:GraphicsSolidFill = new GraphicsSolidFill(2368034, 1);
            ...
            GraphicsUtil.drawCutEdgeRect(0, 0, this._width, (this._height - 27), 6, [1, 1, 1, 1], _local_2);
        ...
        private function addIconTab(_arg_1:int, _arg_2:Bitmap):TabIconView
        {
            ...
            _local_3.x = (_arg_1 * (_local_4.width + 2));
            _local_3.y = 8;
            return (_local_3);
        }
