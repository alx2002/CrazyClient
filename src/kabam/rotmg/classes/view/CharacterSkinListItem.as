...
package kabam.rotmg.classes.view
{
    ...
    public class CharacterSkinListItem extends Sprite 
    {
        ...
        {
            var _local_1:*;
            var _local_2:* = (this.state == CharacterSkinState.OWNED);
            var _local_3:* = (this.state == CharacterSkinState.PURCHASABLE);
            var _local_4:* = (this.state == CharacterSkinState.PURCHASING);
            _local_1 = (this.state == CharacterSkinState.LOCKED);
            this.selectionButton.visible = _local_2;
            ((this.buyButtonContainer) && (this.buyButtonContainer.visible = _local_3));
            this.lock.visible = _local_1;
            this.lockText.visible = ((_local_1) || (_local_4));
        }
