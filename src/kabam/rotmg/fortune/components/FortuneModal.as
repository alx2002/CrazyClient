...
package kabam.rotmg.fortune.components
{
    ...
    public class FortuneModal extends EmptyFrame 
    {
        ...
        private function onItemSwitch(event:TimerEvent=null):void
        {
        ...
        private function onCountdownComplete():void
        {
            ...
            do 
            {
                _local_1 = int(int((Math.random() * 3)));
        ...
        private function resetBalls():void
        {
            ...
            while (_local_3 < 3)
            {
                _local_1 = (((((_local_3 + 1) * 120) - 60) * Math.PI) / 180);
                this.crystals[_local_3].setXPos((this.crystalMain.getCenterX() + (_local_2 * Math.sin(_local_1))));
                this.crystals[_local_3].setYPos((this.crystalMain.getCenterY() + (_local_2 * Math.cos(_local_1))));
                if (this.crystals[_local_3].parent == null)
                {
                    addChild(this.crystals[_local_3]);
                }
                else
                {
                    if (this.crystals[_local_3].visible == false)
                    {
                        this.crystals[_local_3].visible = true;
                    };
                };
                this.crystals[_local_3].removeItemReveal();
                this.crystals[_local_3].setInactive();
                this.crystals[_local_3].reset();
                _local_3++;
            };
        ...
        private function resetBallsRound2():void
        {
            ...
            while (_local_4 < 3)
            {
                if (this.crystals[_local_4] != this.crystalClicked)
                {
                    _local_1 = ((((_local_2 * 120) - 60) * Math.PI) / 180);
                    this.crystals[_local_4].setXPos((this.crystalMain.getCenterX() + (_local_3 * Math.sin(_local_1))));
                    this.crystals[_local_4].setYPos((this.crystalMain.getCenterY() + (_local_3 * Math.cos(_local_1))));
                    _local_2++;
                };
                _local_4++;
            };
        ...
        public function spinCrystals():void
        {
            var _local_1:Number;
            var _local_3:int;
            var _local_2:int = int(int(((200 * Math.abs(((int((getTimer() / 2)) % 1000) - 500))) / 1000)));
            ...
            while (_local_3 < 3)
            {
                _local_1 = ((((((_local_3 + 1) * (120 + this.spinSpeed)) - 60) - getTimer()) * Math.PI) / 180);
                this.crystals[_local_3].setXPos((this.crystalMain.getCenterX() + (this.radius * Math.sin(_local_1))));
                this.crystals[_local_3].setYPos((this.crystalMain.getCenterY() + (this.radius * Math.cos(_local_1))));
                _local_3++;
            };
        ...
        public function onEnterFrame(_arg_1:Event):void
        {
            ...
            var _local_4:int = (_local_3 - this.lastUpdate_);
            fMouseX = mouseX;
            fMouseY = mouseY;
            ...
            while (_local_5 < 3)
            {
                this.crystals[_local_5].update(_local_3, _local_4);
                _local_5++;
            };
