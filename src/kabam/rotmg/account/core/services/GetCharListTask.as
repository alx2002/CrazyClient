        ...
        private function onListComplete(_arg_1:String):void
        {
            ...
            else
            {
                if (_local_5.hasOwnProperty("Account"))
                {
                    ...
                    if (_local_5.Account[0].hasOwnProperty("SecurityQuestions"))
                    {
                        this.securityQuestionsModel.showSecurityQuestionsOnStartup = (_local_5.Account[0].SecurityQuestions[0].ShowSecurityQuestionsDialog[0] == "1");
                        this.securityQuestionsModel.clearQuestionsList();
                        for each (_local_4 in _local_5.Account[0].SecurityQuestions[0].SecurityQuestionsKeys[0].SecurityQuestionsKey)
                        {
                            this.securityQuestionsModel.addSecurityQuestion(_local_4.toString());
                        };
                    };
                };
