...
package kabam.rotmg.chat.control
{
    ...
    public class ParseChatMessageCommand 
    {
        ...
        public static function levenshtein(_arg_1:String, _arg_2:String):int
        {
            ...
            while (_local_5 <= _arg_1.length)
            {
                ...
                while (_local_4 <= _arg_2.length)
                {
                    if (_local_5 != 0)
                    {
                        _local_6[_local_5].push(0);
                    }
                    else
                    {
                        _local_6[_local_5].push(_local_4);
                    };
                    _local_4++;
                };
                _local_6[_local_5][0] = _local_5;
                _local_5++;
            };
            _local_5 = 1;
            while (_local_5 <= _arg_1.length)
            {
                ...
                while (_local_4 <= _arg_2.length)
                {
                    if (_arg_1.charAt((_local_5 - 1)) == _arg_2.charAt((_local_4 - 1)))
                    {
                        _local_3 = 0;
                    }
                    else
                    ...
                    _local_6[_local_5][_local_4] = Math.min((_local_6[(_local_5 - 1)][_local_4] + 1), (_local_6[_local_5][(_local_4 - 1)] + 1), (_local_6[(_local_5 - 1)][(_local_4 - 1)] + _local_3));
                    _local_4++;
                };
                _local_5++;
            };
            return (_local_6[_arg_1.length][_arg_2.length]);
        }
        ...
        private function cjCommands(_arg_1:String):Boolean
        {
            ...
            switch (this.data.toLowerCase())
            {
                ...
                case "/lefttomax":
                    needed = "You need ";
                    _local_14 = true;
                    _local_15 = [int(((((_local_13.maxHPMax_ - _local_13.maxHP_) + _local_13.maxHPBoost_) / 5) + (((((_local_13.maxHPMax_ - _local_13.maxHP_) + _local_13.maxHPBoost_) % 5) > 0) ? 1 : 0))), int(((((_local_13.maxMPMax_ - _local_13.maxMP_) + _local_13.maxMPBoost_) / 5) + (((((_local_13.maxMPMax_ - _local_13.maxMP_) + _local_13.maxMPBoost_) % 5) > 0) ? 1 : 0))), ((_local_13.attackMax_ - _local_13.attack_) + _local_13.attackBoost_), ((_local_13.defenseMax_ - _local_13.defense_) + _local_13.defenseBoost_), ((_local_13.speedMax_ - _local_13.speed_) + _local_13.speedBoost_), ((_local_13.dexterityMax_ - _local_13.dexterity_) + _local_13.dexterityBoost_), ((_local_13.vitalityMax_ - _local_13.vitality_) + _local_13.vitalityBoost_), ((_local_13.wisdomMax_ - _local_13.wisdom_) + _local_13.wisdomBoost_)];
                    _local_16 = ["Life", "Mana", "ATT", "DEF", "SPD", "DEX", "VIT", "WIS"];
                    _local_11 = 0;
                    while (_local_11 < _local_15.length)
                    {
                        if (_local_15[_local_11] > 0)
                        {
                            needed = (needed + (((_local_15[_local_11] + " ") + _local_16[_local_11]) + ", "));
                            _local_14 = false;
                        };
                        _local_11++;
                    };
                    needed = ((_local_14) ? "You're maxed" : (needed.substr(0, (needed.length - 2)) + " to be maxed"));
                ...
                case "/fameclear":
                    ...
                    return (true);
                case "/pos":
                    this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, ((("X: " + _local_13.x_) + " Y: ") + _local_13.y_)));
                    return (true);
                case "/s":
                case "/switch":
                case "/swap":
                    if (_local_13.hasBackpack_)
                    {
                        switch_ = true;
                    }
                    else
                ...
                case "/save":
                    _local_26.record = 0;
                    _local_12 = _local_26.recorded.length;
                    _local_10 = 0;
                    while (_local_10 < _local_26.recorded.length)
                    {
                        _local_11 = (_local_10 + 1);
                        while (_local_11 < _local_26.recorded.length)
                        {
                            if (((_local_26.recorded[_local_10].x == _local_26.recorded[_local_11].x) && (_local_26.recorded[_local_10].y == _local_26.recorded[_local_11].y)))
                            {
                                _local_26.recorded.splice(_local_11, 1);
                                if (_local_10 != 0)
                                {
                                    _local_10--;
                                };
                    ...
                    this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, ((("Save completed. Movement data compressed from " + _local_12) + " steps to ") + _local_26.recorded.length)));
                    return (true);
                case "/play":
                    _local_26.record = 2;
                ...
                case "/stop":
                    _local_26.record = 0;
                    _local_13.recordPointer = 0;
                    this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, "Playback stopped."));
                    return (true);
                case "/myid":
                    this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, ("Id #" + _local_13.objectId_)));
                    return (true);
                case "/constructs":
                case "/const":
                    _local_19 = new Vector.<int>(0);
                    _local_10 = 0;
                    while (_local_10 < Parameters.data_.AAIgnore.length)
                    {
                        _local_18 = Parameters.data_.AAIgnore[_local_10];
                        if ((((_local_18 == 2309) || (_local_18 == 2310)) || (_local_18 == 2311)))
                        {
                            _local_19.push(_local_10);
                    ...
                    else
                    {
                        ...
                        {
                            Parameters.data_.AAIgnore.splice((_local_19[_local_10] - _local_10), 1);
                            _local_10++;
                        };
                ...
                case "/swtree":
                    _local_19 = new Vector.<int>(0);
                    _local_10 = 0;
                    while (_local_10 < Parameters.data_.AAException.length)
                    {
                        _local_18 = Parameters.data_.AAException[_local_10];
                    ...
                    else
                    {
                        ...
                        while (_local_10 < _local_19.length)
                        {
                            Parameters.data_.AAException.splice((_local_19[_local_10] - _local_10), 1);
                            _local_10++;
                        };
                ...
                default:
                    ...
                    _local_8 = this.data.toLowerCase().match("^/colo (\\d*\\.*\\d+)$");
                    if (_local_8 != null)
                    {
                        Parameters.data_.coloOffset = _local_8[1];
                        Parameters.save();
                    ...
                    _local_8 = this.data.toLowerCase().match("^/afk (.+)$");
                    if (_local_8 != null)
                    {
                        TextHandler.afk = true;
                        TextHandler.afkMsg = _local_8[1];
                        afkStart = new CJDateUtil();
                        this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, "Your messages will be saved, have fun."));
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/load (\\d{1,2})$");
                    if (_local_8 != null)
                    {
                        this.hudModel.gameSprite.hudView.miniMap.miniMapData_ = AssetLoader.maps[(parseInt(_local_8[1]) - 1)];
                        this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, "Loaded from file."));
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/player (\\w+)$");
                    if (_local_8 != null)
                    {
                        navigateToURL(new URLRequest(("https://www.realmeye.com/player/" + _local_8[1])), "_blank");
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/sell (\\d{1,2})$");
                    if (_local_8 != null)
                    {
                        _local_21 = (int(_local_8[1]) + 3);
                        navigateToURL(new URLRequest((("https://www.realmeye.com/offers-to/buy/" + _local_13.equipment_[_local_21]) + "/2793")), "_blank");
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/re (\\w+)$");
                    if (_local_8 != null)
                    {
                        _local_22 = ((("/tell " + _local_8[1]) + " ") + lastTell);
                        _local_26.playerText(_local_22);
                        lastTellTo = _local_8[1];
                        lastMsg = _local_22;
                        return (true);
                    };
                    _local_8 = this.data.match("^/name (.+)$");
                    if (_local_8 != null)
                    {
                        Parameters.data_.fakeName = _local_8[1];
                        Parameters.save();
                        this.hudModel.gameSprite.hudView.characterDetails.setName("");
                        return (true);
                    };
                    _local_8 = this.data.match("^/timer (\\d+) ?(\\d*)$");
                    if (_local_8 != null)
                    {
                        Parameters.timerActive = true;
                        Parameters.phaseChangeAt = (getTimer() + (_local_8[1] * 1000));
                        Parameters.phaseName = "Custom Timer";
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/autopot (\\d+)$");
                    if (_local_8 != null)
                    {
                        Parameters.data_.autoPot = _local_8[1];
                        Parameters.save();
                        this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, ("Auto pot percentage set to " + Parameters.data_.autoPot)));
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/automana (\\d+)$");
                    if (_local_8 != null)
                    {
                        Parameters.data_.autoMana = _local_8[1];
                        Parameters.save();
                    ...
                    _local_8 = this.data.toLowerCase().match("^/autoheal (\\d+)$");
                    if (_local_8 != null)
                    {
                        Parameters.data_.autoHealP = _local_8[1];
                        Parameters.save();
                    ...
                    _local_8 = this.data.toLowerCase().match("^/give (\\w+) (\\d{1,8})$");
                    if (_local_8 != null)
                    {
                        _local_26.playerText(((("/tell " + _local_8[1]) + " g=") + _local_8[2]));
                        _local_26.requestTrade(_local_8[1]);
                        _local_23 = new <Boolean>[false, false, false, false, false, false, false, false, false, false, false, false];
                        _local_10 = 4;
                        while (_local_10 < 12)
                        {
                            if (_local_8[2].substr((_local_10 - 4), 1) == "1")
                            {
                                _local_23[_local_10] = true;
                            };
                            _local_10++;
                        };
                    ...
                    _local_8 = this.data.toLowerCase().match("^/find (.+)$");
                    if (_local_8 != null)
                    {
                        this.findItem(this.findMatch2(_local_8[1]));
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/take (.+)$");
                    if (_local_8 != null)
                    {
                        ...
                        if (_local_8[1] == "pots")
                        {
                            _local_13.collect = int.MAX_VALUE;
                            this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, "Taking Potion(s) from vault chests"));
                            return (true);
                        };
                        _local_13.collect = this.findMatch2(_local_8[1]);
                        this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, (("Taking " + ObjectLibrary.getIdFromType(_local_13.collect)) + "(s) from vault chests")));
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/put (.+)$");
                    if (_local_8 != null)
                    {
                        if (this.hudModel.gameSprite.map.name_ != "Vault")
                        {
                        ...
                        if (_local_8[1] == "pots")
                        {
                            _local_13.collect = int.MIN_VALUE;
                            this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, "Putting Potion(s) to vault chests"));
                            return (true);
                        };
                        _local_13.collect = (0 - this.findMatch2(_local_8[1]));
                        this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, (("Putting " + ObjectLibrary.getIdFromType((0 - _local_13.collect))) + "(s) to vault chests")));
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/buy (\\w+) ?(\\w*)$");
                    if (_local_8 != null)
                    {
                        if (_local_8[2] == "")
                        {
                            navigateToURL(new URLRequest((("https://www.realmeye.com/offers-to/sell/" + this.findMatch2(_local_8[1])) + "/2793")), "_blank");
                        }
                        else
                        {
                            navigateToURL(new URLRequest(((("https://www.realmeye.com/offers-to/sell/" + this.findMatch2(_local_8[1])) + "/") + this.findMatch2(_local_8[2]))), "_blank");
                        };
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/sell (\\w+) ?(\\w*)$");
                    if (_local_8 != null)
                    {
                        if (_local_8[2] == "")
                        {
                            navigateToURL(new URLRequest((("https://www.realmeye.com/offers-to/buy/" + this.findMatch2(_local_8[1])) + "/2793")), "_blank");
                        }
                        else
                        {
                            navigateToURL(new URLRequest(((("https://www.realmeye.com/offers-to/buy/" + this.findMatch2(_local_8[1])) + "/") + this.findMatch2(_local_8[2]))), "_blank");
                        };
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/dye1 (.+)$");
                    if (_local_8 != null)
                    {
                        if (_local_8[1] == "none")
                        {
                        ...
                        {
                            Parameters.data_.setTex1 = this.getTex1(this.findMatch2((_local_8[1] + " cloth")));
                            Parameters.save();
                            _local_13.setTex1(Parameters.data_.setTex1);
                        };
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/dye2 (.+)$");
                    if (_local_8 != null)
                    {
                        if (_local_8[1] == "none")
                        {
                        ...
                        {
                            Parameters.data_.setTex2 = this.getTex1(this.findMatch2((_local_8[1] + " cloth")));
                            Parameters.save();
                            _local_13.setTex2(Parameters.data_.setTex2);
                        };
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/dye (.+)$");
                    if (_local_8 != null)
                    {
                        if (_local_8[1] == "none")
                        {
                        ...
                        {
                            _local_8[1] = this.getTex1(this.findMatch2((_local_8[1] + " cloth")));
                            Parameters.data_.setTex1 = _local_8[1];
                            Parameters.data_.setTex2 = _local_8[1];
                            Parameters.save();
                            _local_13.setTex1(Parameters.data_.setTex1);
                            _local_13.setTex2(Parameters.data_.setTex2);
                        };
                    ...
                    _local_8 = this.data.toLowerCase().match("^/skin (.+)$");
                    if (_local_8 != null)
                    {
                        if (_local_8[1] == "none")
                        {
                            ...
                            Parameters.save();
                            _local_13.size_ = 100;
                            _local_26.setPlayerSkinTemplate(_local_13, 0);
                        }
                        else
                        {
                            Parameters.data_.nsetSkin = this.findSkinIndex(_local_8[1]);
                            Parameters.save();
                        };
                        return (true);
                    };
                    ...
                    if (_local_8 != null)
                    {
                        ...
                        {
                            _local_26.teleport(this.fixedName(_local_8[1]).name_);
                        };
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/teleport (\\w+)$");
                    if (_local_8 != null)
                    {
                        if ((!(Parameters.data_.blockTP)))
                        {
                    ...
                    _local_8 = this.data.toLowerCase().match("^/follow (\\w+)$");
                    if (_local_8 != null)
                    {
                        _local_24 = this.fixedName(_local_8[1]);
                        _local_26.teleport(_local_24.name_);
                        _local_13.followTarget = _local_24;
                        return (true);
                    };
                    _local_8 = this.data.toLowerCase().match("^/setspd (-?\\d+)$");
                    if (_local_8 != null)
                    {
                        _local_13.speed_ = parseInt(_local_8[1]);
                        return (true);
                    };
                    _local_8 = this.data.match("^/getid (\\w+)");
                    if (_local_8 != null)
                    {
                        for each (_local_25 in _local_13.map_.goDict_)
                        {
                            if ((_local_25 is Player))
                            {
                                if (_local_8[1] == _local_25.name_.toLowerCase())
                                {
                    ...
                    _local_8 = this.data.toLowerCase().match("^/connect ([0-9.]+)$");
                    if (_local_8 != null)
                    {
                        this.addTextLine.dispatch(ChatMessage.make(Parameters.HELP_CHAT_NAME, ("Connecting to " + _local_8[1])));
                        this.hudModel.gameSprite.dispatchEvent(new ReconnectEvent(new Server().setName("Custom").setAddress(_local_8[1]).setPort(2050), -2, false, this.hudModel.gameSprite.gsc_.charId_, getTimer(), new ByteArray(), false));
                        return (true);
                    };
            };
            return (false);
        ...
        private function findMatch2(_arg_1:String):int
        {
            ...
            var _local_5:String;
            var _local_6:int;
            var _local_7:Vector.<String> = new <String>["def", "att", "spd", "dex", "vit", "wis", "ubhp"];
            var _local_8:Vector.<int> = new <int>[2592, 2591, 2593, 2636, 2612, 2613, 2985];
            while (_local_6 < _local_7.length)
            {
                if (_arg_1 == _local_7[_local_6])
                {
                    return (_local_8[_local_6]);
                };
                _local_6++;
            };
            var _local_9:Array = _arg_1.split(" ");
        ...
        private function findItem(_arg_1:int):void
        {
            ...
            var _local_7:Vector.<Player> = new Vector.<Player>(0);
            var _local_8:AbstractMap = this.hudModel.gameSprite.map;
            var _local_9:Player = this.hudModel.gameSprite.map.player_;
            for each (_local_3 in _local_8.goDict_)
            {
                if ((_local_3 is Player))
                {
                    _local_5 = (_local_3 as Player);
                    if ((!((_local_5 == _local_8.player_) || (!(_local_5.nameChosen_)))))
                    {
                        ...
                        if (_local_6 > 0)
                        {
                            ...
                            _local_5.lastAltAttack_ = _local_6;
                            _local_6 = 0;
                        };
                    };
                };
            ...
            {
                this.openDialog.dispatch(new FindMenu(this.hudModel.gameSprite, _local_7, ObjectLibrary.getIdFromType(_arg_1)));
            }
            else
            {
