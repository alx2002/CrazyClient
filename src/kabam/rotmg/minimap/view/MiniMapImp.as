...
package kabam.rotmg.minimap.view
{
    ...
    public class MiniMapImp extends MiniMap 
    {
        ...
        override public function draw():void
        {
            ...
            _local_5 = this.enemyLayer_.graphics;
            ...
            for each (_local_2 in map.goDict_)
            {
                if ((!((_local_2.props_.noMiniMap_) || (_local_2 == this.focus))))
                {
                    ...
                    _local_6 = (((this.mapMatrix_.a * _local_2.x_) + (this.mapMatrix_.c * _local_2.y_)) + this.mapMatrix_.tx);
                    _local_7 = (((this.mapMatrix_.b * _local_2.x_) + (this.mapMatrix_.d * _local_2.y_)) + this.mapMatrix_.ty);
                    if (((((_local_6 <= (-(this._width) / 2)) || (_local_6 >= (this._width / 2))) || (_local_7 <= (-(this._height) / 2))) || (_local_7 >= (this._height / 2))))
                    {
                        RectangleUtil.lineSegmentIntersectXY(this.windowRect_, 0, 0, _local_6, _local_7, this.tempPoint);
                        _local_6 = this.tempPoint.x;
                        _local_7 = this.tempPoint.y;
                    };
                    if ((((!(_local_4 == null)) && (this.isMouseOver)) && ((this.menu == null) || (this.menu.parent == null))))
                    {
                        _local_8 = (_local_18 - _local_6);
                        _local_9 = (_local_19 - _local_7);
                        _local_10 = ((_local_8 * _local_8) + (_local_9 * _local_9));
                        if (_local_10 < MOUSE_DIST_SQ)
                        {
                            this.players_.push(_local_4);
                        };
                    };
                    _local_1.beginFill(_local_3);
                    _local_1.drawRect((_local_6 - 2), (_local_7 - 2), 4, 4);
                    _local_1.endFill();
                };
            };
            if (this.players_.length != 0)
