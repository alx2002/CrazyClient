...
package kabam.rotmg.dailyLogin.view
{
    ...
    public class CalendarDayBox extends Sprite 
    {
        ...
        public function CalendarDayBox(_arg_1:CalendarDayModel, _arg_2:int, _arg_3:Boolean)
        {
            ...
            super();
            this.day = _arg_1;
            var _local_8:int = int(int(int(Math.ceil((_arg_1.dayNumber / CalendarSettings.NUMBER_OF_COLUMNS)))));
            var _local_9:int = int(int(int(Math.ceil((_arg_2 / CalendarSettings.NUMBER_OF_COLUMNS)))));
