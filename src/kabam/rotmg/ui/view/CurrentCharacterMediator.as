...
package kabam.rotmg.ui.view
{
    ...
    public class CurrentCharacterMediator extends Mediator 
    {
        ...
        {
            var _local_1:TrackingData;
            var _local_2:String = MoreDateUtil.getDayStringInPT();
            if (Parameters.data_.lastDailyAnalytics != _local_2)
            {
                _local_1 = new TrackingData();
                _local_1.category = "joinDate";
                _local_1.action = Parameters.data_.joinDate;
                Parameters.data_.lastDailyAnalytics = _local_2;
                Parameters.save();
            };
        }
