	...
	public class SimpleTimeline extends Animation
	{
		...
		public function add(_arg_1:*, _arg_2:* = "+=0", _arg_3:String = "normal", _arg_4:Number = 0):*
		{
			...
			if (_arg_1._paused)
			{
				...
				{
					_arg_1._pauseTime = (_arg_1._startTime + ((this.rawTime() - _arg_1._startTime) / _arg_1._timeScale));
				}
				;
			}
			;
			...
			;
			var _local_6:Animation = this._last;
			...
			{
				_arg_1._next = this._first;
				this._first = Animation(_arg_1);
			}
			;
			if (_arg_1._next)
			{
		...
		public function _remove(_arg_1:Animation, _arg_2:Boolean = false):*
		{
			if (_arg_1.timeline == this)
			{
				...
				{
					if (this._first === _arg_1)
					{
						this._first = _arg_1._next;
					}
					;
				}
				;
				...
				{
					if (this._last === _arg_1)
					{
						this._last = _arg_1._prev;
					}
					;
				}
				;
		...
		override public function render(_arg_1:Number, _arg_2:Boolean = false, _arg_3:Boolean = false):void
		{
			...
			var _local_5:Animation = this._first;
