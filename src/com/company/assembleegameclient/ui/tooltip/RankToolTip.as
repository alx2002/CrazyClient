...
package com.company.assembleegameclient.ui.tooltip
{
	...
	public class RankToolTip extends ToolTip
	{
		...
		private function textAdded():void
		{
			...
			var _local_3:Rectangle = this.earnedText_.getBounds(this);
			this.star_.x = (_local_3.right + 7);
			...
			{
				_local_1 = new LegendLine((_local_4 * ObjectLibrary.playerChars_.length), (((_local_4 + 1) * ObjectLibrary.playerChars_.length) - 1), FameUtil.COLORS[_local_4]);
