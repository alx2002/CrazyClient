...
package com.company.assembleegameclient.ui.tooltip
{
	...
	public class MyPlayerToolTip extends ToolTip
	{
		...
		public function createUI():void
		{
			...
			var _local_2:int = int(this.charXML.ObjectType);
			var _local_3:XML = ObjectLibrary.xmlLibrary_[_local_2];
			this.player_ = Player.fromPlayerXML(this.accountName, this.charXML);
			var _local_4:CharacterClass = this.classes.getCharacterClass(this.player_.objectType_);
			var _local_5:CharacterSkin = _local_4.skins.getSkin(this.charXML.Texture);
			this.player_.animatedChar_ = this.factory.makeCharacter(_local_5.template);
			...
			if (_local_6 > 0)
			{
				this.makeNextClassQuestText(_local_6, _local_3);
			}
			;
		}
		...
		public function makeNextClassQuestText(_arg_1:int, _arg_2:XML):void
		{
			...
			this.nextClassQuest_.setStringBuilder(new LineBuilder().setParams(TextKey.MY_PLAYER_TOOL_TIP_NEXT_CLASS_QUEST, {"nextStarFame": _arg_1, "character": ClassToolTip.getDisplayId(_arg_2)}));
		...
		public function makeBestLevelText():void
		{
			...
			this.bestLevel_.setStringBuilder(new LineBuilder().setParams(TextKey.BESTLEVEL__STATS, {"numStars": _local_1, "bestLevel": _local_2, "fame": _local_3}));
