...
package com.company.assembleegameclient.ui.tooltip.slotcomparisons
{
	...
	public class HelmetComparison extends SlotComparison
	{
		...
		private function handleBerserk():void
		{
			...
			_local_8.pushParams(TextKey.EFFECT_FOR_DURATION, {"effect": TextKey.wrapForTokenResolution(TextKey.ACTIVE_EFFECT_BERSERK), "duration": _local_3.toString()}, TooltipHelper.getOpenTag(_local_7), TooltipHelper.getCloseTag());
		...
		private function handleSpeedy():void
		{
			...
			if (((!(this.speedy == null)) && (!(this.otherSpeedy == null))))
			{
				...
				comparisonStringBuilder.pushParams(TextKey.EFFECT_FOR_DURATION, {"effect": TextKey.wrapForTokenResolution(TextKey.ACTIVE_EFFECT_SPEEDY), "duration": _local_1.toString()}, TooltipHelper.getOpenTag(getTextColor((_local_1 - _local_2))), TooltipHelper.getCloseTag());
			...
			else
			{
				...
				{
					comparisonStringBuilder.pushParams(TextKey.EFFECT_ON_SELF, {"effect": ""});
					comparisonStringBuilder.pushParams(TextKey.EFFECT_FOR_DURATION, {"effect": TextKey.wrapForTokenResolution(TextKey.ACTIVE_EFFECT_SPEEDY), "duration": this.speedy.@duration}, TooltipHelper.getOpenTag(BETTER_COLOR), TooltipHelper.getCloseTag());
					processedTags[this.speedy.toXMLString()] = true;
				}
				;
			}
		...
		private function handleArmored():void
		{
			...
			{
				comparisonStringBuilder.pushParams(TextKey.EFFECT_ON_SELF, {"effect": ""});
				comparisonStringBuilder.pushParams(TextKey.EFFECT_FOR_DURATION, {"effect": TextKey.wrapForTokenResolution(TextKey.ACTIVE_EFFECT_ARMORED), "duration": this.armored.@duration}, TooltipHelper.getOpenTag(UNTIERED_COLOR), TooltipHelper.getCloseTag());
