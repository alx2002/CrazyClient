...
package com.company.assembleegameclient.ui.tooltip.slotcomparisons
{
	...
	public class CloakComparison extends SlotComparison
	{
		...
		private function appendDurationText(_arg_1:Number, _arg_2:Number):void
		{
			...
			comparisonStringBuilder.pushParams(TextKey.EFFECT_FOR_DURATION, {"effect": TextKey.wrapForTokenResolution(TextKey.ACTIVE_EFFECT_INVISIBLE), "duration": _arg_1.toString()}, TooltipHelper.getOpenTag(_local_3), TooltipHelper.getCloseTag());
		}
