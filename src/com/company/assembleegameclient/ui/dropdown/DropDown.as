...
package com.company.assembleegameclient.ui.dropdown
{
    ...
    public class DropDown extends Sprite 
    {
        ...
        private function showAll():void
        {
            ...
            var _local_6:int = int(int(Math.ceil((this.strings_.length / this.maxItems_))));
            while (_local_5 < _local_6)
            {
                _local_1 = (_local_5 * this.maxItems_);
                _local_2 = Math.min((_local_6 + this.maxItems_), this.strings_.length);
                _local_3 = (this.xOffset_ - (this.w_ * _local_5));
