	...
	public class GuildRegisterPanel extends Panel
	{
		...
		public function GuildRegisterPanel(_arg_1:GameSprite)
		{
			...
			if (((!(_local_2.guildName_ == null)) && (_local_2.guildName_.length > 0)))
			{
				...
				this.title_.setStringBuilder(new LineBuilder().setParams(TextKey.GUILD_REGISTER_PANEL_RANK, {"rank": _local_3, "guildName": _local_2.guildName_}).setPrefix('<p align="center">').setPostfix("</p>"));
				this.title_.y = 0;
