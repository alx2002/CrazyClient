...
package com.company.assembleegameclient.screens.charrects
{
	...
	public class CurrentCharacterRect extends CharacterRect
	{
		...
		public function CurrentCharacterRect(_arg_1:String, _arg_2:CharacterClass, _arg_3:SavedCharacter, _arg_4:CharacterStats)
		{
			...
			super.className = new LineBuilder().setParams(TextKey.CURRENT_CHARACTER_DESCRIPTION, {"className": _local_5, "level": _local_6});
		...
		private function makeTagline():void
		{
			if (this.getNextStarFame() > 0)
			{
				...
				super.makeTaglineText(new LineBuilder().setParams(TextKey.CURRENT_CHARACTER_TAGLINE, {"fame": this.char.fame(), "nextStarFame": this.getNextStarFame()}));
