...
package com.company.assembleegameclient.mapeditor
{
	...
	public class MEMap extends Sprite
	{
		...
		public function resize(_arg_1:Number):void
		{
			...
			for (_local_6 in _local_7)
			{
				...
				else
				{
					...
					_local_5 = int(int((_local_3 / _local_8)));
		...
		public function modifyTile(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int):void
		{
			...
			var _arg_2:int = _arg_2;
			var _arg_3:int = _arg_3;
			var _arg_4:int = _arg_4;
			x = _arg_1;
			y = _arg_2;
		...
		public function getTileBounds():Rectangle
		{
			...
			for (_local_1 in this.tileDict_)
			{
				...
				if ((!(_local_2.isEmpty())))
				{
					...
					_local_5 = int(int((_local_3 / NUM_SQUARES)));
			...
			;
			return (new Rectangle(_local_8, _local_9, (_local_6 - _local_8), (_local_7 - _local_9)));
		}
		...
		public function draw():void
		{
			...
			var _local_4:int = int(int((SIZE / this.zoom_)));
		...
		public function getMapStatistics():Object
		{
			...
			;
			return ({"numObjects": _local_3, "numGrounds": _local_2, "numExits": _local_4, "numEntries": _local_5, "numTiles": _local_6, "thumbnail": this.generateThumbnail()});
		}
