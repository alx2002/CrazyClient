...
package com.company.assembleegameclient.mapeditor
{
	...
	public class Chooser extends Sprite
	{
		...
		private function cleanupElements():void
		{
			...
			var _local_2:int = (this.elements_.length - 1);
			while (_local_2 >= 0)
			{
				_local_1 = this.elements_.pop();
		...
		private function downloadElement(_arg_1:Element):void
		{
			...
			var _local_3:FileReference;
			var _local_4:BitmapData = _arg_1.objectBitmap;
			if (_local_4 != null)
			{
				_local_2 = PNGEncoder.encode(_arg_1.objectBitmap);
				_local_3 = new FileReference();
				_local_3.save(_local_2, (_arg_1.type_ + ".png"));
			}
			;
		}
