...
package com.company.assembleegameclient.mapeditor
{
	...
	public class EnemyChooser extends Chooser
	{
		...
		public function reloadObjects(_arg_1:String, _arg_2:String = "", _arg_3:Number = 0, _arg_4:Number = -1):void
		{
			...
			var _local_13:Vector.<String> = new Vector.<String>();
			if (_arg_1 != "")
			{
				_local_6 = new RegExp(_arg_1, "gix");
			}
			;
			if (_arg_2 != "")
			{
			...
			;
			var _local_14:Dictionary = GroupDivider.GROUPS["Enemies"];
			for each (_local_5 in _local_14)
			{
				_local_7 = String(_local_5.@id);
				if ((!((!(_local_6 == null)) && (_local_7.search(_local_6) < 0))))
				{
					if (_arg_2 != "")
					{
						_local_12 = ((_local_5.hasOwnProperty(_arg_2)) ? Number(_local_5.elements(_arg_2)) : -1);
						if (_local_12 < 0) continue;
						_local_10 = (_local_12 >= _arg_3);
						_local_11 = (!((_arg_4 > 0) && (_local_12 > _arg_4)));
					}
					;
					if (((_local_10) && (_local_11)))
					{
						_local_13.push(_local_7);
					}
					;
				}
				;
			...
			;
			_local_13.sort(MoreStringUtil.cmp);
			for each (_local_7 in _local_13)
			{
