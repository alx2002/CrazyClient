...
package com.company.assembleegameclient.util
{
    ...
    public class TextureRedrawer 
    {
        ...
        public static function retextureNoSizeChange(_arg_1:BitmapData, _arg_2:BitmapData, _arg_3:int, _arg_4:int):BitmapData
        {
            ...
            var _local_9:ShaderData = shader.data;
            _local_9.src.input = _local_6;
            _local_9.mask.input = _arg_2;
            _local_9.texture1.input = _local_7;
            _local_9.texture2.input = _local_8;
            _local_9.texture1Size.value = [((_arg_3 == 0) ? 0 : _local_7.width)];
            _local_9.texture2Size.value = [((_arg_4 == 0) ? 0 : _local_8.width)];
