...
package com.company.assembleegameclient.objects
{
    ...
    public class GameObject extends BasicObject 
    {
        ...
        public static function damageWithDefense(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:Vector.<uint>):int
        {
            ...
            var _local_6:int = int(int(((_arg_1 * 3) / 20)));
        ...
        public static function takeDmgNotif(_arg_1:int, _arg_2:GameObject, _arg_3:Boolean=false):void
        {
            ...
            else
            {
                ...
                {
                    _local_4 = int(int(green2red(((_arg_2.hp_ / _arg_2.maxHP_) * 100))));
                }
                else
                {
                    _local_4 = 0xFF0000;
        ...
        public static function green2red(_arg_1:int):int
        {
            if (_arg_1 > 50)
            {
                return (0xFF00 + (0x50000 * int((100 - _arg_1))));
            };
        ...
        public function damage(_arg_1:Boolean, _arg_2:int, _arg_3:Vector.<uint>, _arg_4:Boolean, _arg_5:Projectile, _arg_6:Boolean=false):void
        {
            ...
            if ((((_arg_2 > 0) && (!(this.dead_))) && (!(map_ == null))))
            {
                ...
                _local_15 = ((((this.isArmorBroken()) || ((!(_arg_5 == null)) && (_arg_5.projProps_.armorPiercing_))) || (_local_16)) || (_arg_6));
        ...
        public function drawName(_arg_1:Vector.<IGraphicsData>, _arg_2:Camera, _arg_3:Boolean=false):void
        {
            ...
            var _local_4:int = ((this.nameBitmapData_.width * 0.5) + 1);
            var _local_5:Vector.<Number> = this.namePath_.data;
            _local_5.length = 0;
            if (_arg_3)
            {
                _local_5.push((posS_[0] - _local_4), (posS_[1] + 12), (posS_[0] + _local_4), (posS_[1] + 12), (posS_[0] + _local_4), (posS_[1] + 42), (posS_[0] - _local_4), (posS_[1] + 42));
            }
            else
            {
                _local_5.push((posS_[0] - _local_4), posS_[1], (posS_[0] + _local_4), posS_[1], (posS_[0] + _local_4), (posS_[1] + 30), (posS_[0] - _local_4), (posS_[1] + 30));
            };
        ...
        protected function getTexture(_arg_1:Camera, _arg_2:int):BitmapData
        {
            ...
            if (this.animatedChar_ != null)
            {
                ...
                else
                {
                    if (((!(this.moveVec_.x == 0)) || (!(this.moveVec_.y == 0))))
                    {
                        _local_7 = int(int((0.5 / this.moveVec_.length)));
            ...
            if (_arg_1.isHallucinating_)
            {
                ...
                _local_11 = null;
                _local_13 = int(int((this.size_ * Math.min(1.5, (_local_9 / _local_12.width)))));
            };
            if ((!(this is Pet)))
            {
        ...
        public function getPortrait():BitmapData
        {
            ...
            if (this.portrait_ == null)
            {
                ...
                _local_2 = int(int(((4 / _local_1.width) * 100)));
        ...
        protected function drawHpBar(_arg_1:Vector.<IGraphicsData>, _arg_2:int=6):void
        {
            ...
            var _local_7:* = 1.2;
            (this.hpbarBackPath_.data as Vector.<Number>).push(((posS_[0] - _local_5) - _local_7), ((posS_[1] + _arg_2) - _local_7), ((posS_[0] + _local_5) + _local_7), ((posS_[1] + _arg_2) - _local_7), ((posS_[0] + _local_5) + _local_7), (((posS_[1] + _arg_2) + _local_6) + _local_7), ((posS_[0] - _local_5) - _local_7), (((posS_[1] + _arg_2) + _local_6) + _local_7));
            _arg_1.push(this.hpbarBackFill_);
            _arg_1.push(this.hpbarBackPath_);
            _arg_1.push(GraphicsUtil.END_FILL);
            if (this.hp_ > 0)
            {
                _local_3 = (this.hp_ / this.maxHP_);
                _local_4 = ((_local_3 * 2) * _local_5);
                this.hpbarPath_.data.length = 0;
                (this.hpbarPath_.data as Vector.<Number>).push((posS_[0] - _local_5), (posS_[1] + _arg_2), ((posS_[0] - _local_5) + _local_4), (posS_[1] + _arg_2), ((posS_[0] - _local_5) + _local_4), ((posS_[1] + _arg_2) + _local_6), (posS_[0] - _local_5), ((posS_[1] + _arg_2) + _local_6));
                this.hpbarFill_.color = ((_local_3 < 0.5) ? ((_local_3 < 0.2) ? 14684176 : 16744464) : 0x10FF00);
        ...
        override public function draw(_arg_1:Vector.<IGraphicsData>, _arg_2:Camera, _arg_3:int):void
        {
            ...
            var _local_6:uint;
            var _local_7:int;
            var _local_8:BitmapData = this.getTexture(_arg_2, _arg_3);
            if (this.props_.drawOnGround_)
            {
                ...
                this.bitmapFill_.bitmapData = _local_8;
            ...
            var _local_9:Boolean = (((((this.props_) && ((this.props_.isEnemy_) || (this.props_.isPlayer_))) && (!(this.isInvincible()))) && ((this.props_.isPlayer_) || (!(this.isInvulnerable())))) && (!(this.props_.noMiniMap_)));
            if (this.obj3D_ != null)
            {
                if ((((_local_9) && (this.bHPBarParamCheck())) && (this.props_.healthBar_)))
                {
                    this.drawHpBar(_arg_1, this.props_.healthBar_);
                };
                if ((!(Parameters.isGpuRender())))
                {
                    this.obj3D_.draw(_arg_1, _arg_2, this.props_.color_, _local_8);
                    return;
                };
                if (Parameters.isGpuRender())
                {
            ...
            var _local_10:int = _local_8.width;
            var _local_11:int = _local_8.height;
            var _local_12:int = (square_.sink_ + this.sinkLevel_);
            if (((_local_12 > 0) && ((this.flying_) || ((!(square_.obj_ == null)) && (square_.obj_.props_.protectFromSink_)))))
            {
                _local_12 = 0;
            };
            if (Parameters.isGpuRender())
            {
                if (_local_12 != 0)
                {
                    GraphicsFillExtra.setSinkLevel(this.bitmapFill_, Math.max((((_local_12 / _local_11) * 1.65) - 0.02), 0));
                    _local_12 = (-(_local_12) + 0.02);
                }
                else
                {
                    if (((_local_12 == 0) && (!(GraphicsFillExtra.getSinkLevel(this.bitmapFill_) == 0))))
                    {
            ...
            this.vS_.length = 0;
            this.vS_.push((posS_[3] - (_local_10 / 2)), ((posS_[4] - _local_11) + _local_12), (posS_[3] + (_local_10 / 2)), ((posS_[4] - _local_11) + _local_12), (posS_[3] + (_local_10 / 2)), posS_[4], (posS_[3] - (_local_10 / 2)), posS_[4]);
            ...
            if (this.flash_ != null)
            {
                if ((!(this.flash_.doneAt(_arg_3))))
                {
                    if (Parameters.isGpuRender())
                    {
                        this.flash_.applyGPUTextureColorTransform(_local_8, _arg_3);
                    }
                    else
                    {
                        _local_8 = this.flash_.apply(_local_8, _arg_3);
                    };
                }
                else
                {
            ...
            if (((this.isShocked) && (!(this.isShockedTransformSet))))
            {
                if (Parameters.isGpuRender())
                {
                    GraphicsFillExtra.setColorTransform(_local_8, new ColorTransform(-1, -1, -1, 1, 0xFF, 0xFF, 0xFF, 0));
                }
                else
                {
                    _local_4 = _local_8.clone();
            ...
            if (_local_9)
            {
                _local_5 = uint(uint(((_local_8.getPixel32((_local_8.width / 4), (_local_8.height / 4)) | _local_8.getPixel32((_local_8.width / 2), (_local_8.height / 2))) | _local_8.getPixel32(((_local_8.width * 3) / 4), ((_local_8.height * 3) / 4)))));
                _local_6 = (_local_5 >> 24);
                if (_local_6 != 0)
                {
                    hasShadow_ = true;
                    _local_7 = (((this.props_.isPlayer_) && (!(this == map_.player_))) ? 12 : 0);
                    if (((this.bHPBarParamCheck()) && (!(this.props_.healthBar_ == -1))))
                    {
                        this.drawHpBar(_arg_1, ((this.props_.healthBar_) ? this.props_.healthBar_ : (_local_7 + DEFAULT_HP_BAR_Y_OFFSET)));
                    };
                }
                else
                {
            ...
            if ((((!(this.dead_)) && (Parameters.data_.showDamageOnEnemy)) && (!(Options.hidden))))
            {
                if (this.footer_)
                {
                    _local_6 = Parameters.dmgCounter[this.objectId_];
                    if (_local_6 != this.lastPercent_)
                    {
                        _local_6 = uint(int(((_local_6 / this.maxHP_) * 100)));
                        this.name_ = (_local_6 + "%");
                        this.lastPercent_ = _local_6;
                        this.nameBitmapData_ = null;
        ...
        public function drawConditionIcons(_arg_1:Vector.<IGraphicsData>, _arg_2:Camera, _arg_3:int):void
        {
            ...
            this.icons_.length = 0;
            var _local_11:int = int(int((_arg_3 / 500)));
