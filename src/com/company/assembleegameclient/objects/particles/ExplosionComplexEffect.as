...
package com.company.assembleegameclient.objects.particles
{
	...
	public class ExplosionComplexEffect extends ParticleEffect
	{
		...
		{
			var _local_4:ExplosionComplexParticle;
			var _local_5:int;
			...
			{
				_local_6 = ((Math.random() * Math.PI) * 2);
				_local_7 = (this.minRad_ + (Math.random() * (this.maxRad_ - this.minRad_)));
				_local_8 = ((_local_7 * Math.cos(_local_6)) / (0.008 * this.maxLife_));
				_local_9 = ((_local_7 * Math.sin(_local_6)) / (0.008 * this.maxLife_));
				_local_10 = (Math.random() * Math.PI);
				_local_11 = 0;
				_local_4 = new ExplosionComplexParticle(this.color_, 0.2, size_, this.maxLife_, _local_8, _local_9, _local_11);
