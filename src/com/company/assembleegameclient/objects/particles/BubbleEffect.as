...
package com.company.assembleegameclient.objects.particles
{
	...
	public class BubbleEffect extends ParticleEffect
	{
		...
		override public function update(_arg_1:int, _arg_2:int):Boolean
		{
			...
			;
			_local_3 = int(int(int((this.lastUpdate_ / this.rate_))));
			_local_11 = int(int(int((_arg_1 / this.rate_))));
			_local_12 = this.go_.x_;
			_local_7 = this.go_.y_;
			...
			while (_local_13 < _local_11)
			{
				...
				_local_8.restart(_local_4, _arg_1);
				_local_5 = (Math.random() * Math.PI);
				_local_6 = (Math.random() * 0.4);
				_local_9 = (_local_12 + (_local_6 * Math.cos(_local_5)));
				_local_10 = (_local_7 + (_local_6 * Math.sin(_local_5)));
