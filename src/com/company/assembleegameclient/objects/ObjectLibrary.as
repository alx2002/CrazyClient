...
package com.company.assembleegameclient.objects
{
	...
	public class ObjectLibrary
	{
		...
		public static function getItemIcon(_arg_1:int):BitmapData
		{
			...
			if (_arg_1 == -1)
			{
				_local_2 = scaleBitmapData(AssetLibrary.getImageFromSet("lofiInterface", 7), 2);
				_local_10.translate(4, 4);
				_local_3 = new BitmapData(22, 22, true, 0);
				_local_3.draw(_local_2, _local_10);
				return (_local_3);
			}
			;
			_local_4 = xmlLibrary_[_arg_1];
			_local_5 = typeToTextureData_[_arg_1];
			_local_6 = ((_local_5) ? _local_5.mask_ : null);
			_local_7 = (("Tex1" in _local_4) ? _local_4.Tex1 : 0);
			_local_8 = (("Tex2" in _local_4) ? _local_4.Tex2 : 0);
			_local_9 = getTextureFromType(_arg_1);
			if ((((!(_local_7 == 0)) || (!(_local_8 == 0))) && ((!(_arg_1 == 317)) && (!(_arg_1 == 318)))))
			{
				_local_9 = TextureRedrawer.retextureNoSizeChange(_local_9, _local_6, _local_7, _local_8);
				_local_10.scale(0.2, 0.2);
			}
			;
			_local_2 = scaleBitmapData(_local_9, 2);
			_local_10.translate(4, 4);
			_local_3 = new BitmapData(22, 22, true, 0);
			_local_3.draw(_local_2, _local_10);
		...
		public static function scaleBitmapData(_arg_1:BitmapData, _arg_2:Number):BitmapData
		{
			...
			var _local_3:int = ((_arg_1.width * _arg_2) || (1));
			var _local_4:int = ((_arg_1.height * _arg_2) || (1));
			var _local_5:BitmapData = new BitmapData(_local_3, _local_4, true, 0);
			var _local_6:Matrix = new Matrix();
			_local_6.scale(_arg_2, _arg_2);
